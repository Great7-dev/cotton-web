...
export function WorkForceEnterprise() {
  return (
      ...
      <div className="bg-[#151515] text-white rounded-lg overflow-hidden max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row">
          <div className="p-6 md:p-8 flex flex-col justify-center md:max-w-[60%]">
            <h1 className="text-2xl md:text-3xl font-medium font-['InterDisplay'] mb-2">
              Ready to <br />
              <span className="text-[#1FC16B] italic">Simplify</span> Your
              Business?
            </h1>
